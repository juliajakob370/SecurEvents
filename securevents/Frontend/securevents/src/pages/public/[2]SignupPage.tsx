...
const SignupPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await requestSignupCode(formData.firstName.trim(), formData.lastName.trim(), formData.email.trim());
            ...
            setErrors({ email: err instanceof Error ? err.message : "Failed to send signup code." });
        } finally {
            setLoading(false);
        }
    };
