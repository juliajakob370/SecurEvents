...
public class SecurityRequestLoggingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        // This supports forensic analysis for unauthorized event edits/deletes.
        ...
        _logger.LogInformation(
            "SECURITY_AUDIT service=event-management method={Method} path={Path} status={StatusCode} userId={UserId} ip={Ip} userAgent={UserAgent} traceId={TraceId} durationMs={Duration}",
